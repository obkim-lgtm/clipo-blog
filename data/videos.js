...
window.VIDEOS = [
  ...
  { id: 'S2', cat: 'start', art: 'people_plus', title: '학생 등록하고 수업 만들기', dur: '0:48', yt: null,
    mp4: 'video/s2.mp4?v=1', poster: 'video/s2_poster.jpg?v=1', screen: '학교 설정 · 수업', isNew: true,
    summary: '학교 설정에서 학생 계정을 한 명씩 또는 엑셀로 만들고, 홈에서 첫 수업을 만들어 참여 학생을 확인해요.' },
