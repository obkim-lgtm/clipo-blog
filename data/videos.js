...
window.VIDEOS = [
  ...
  { id: 'S1', cat: 'start', art: 'people_plus', title: '학교 설정에서 학생 계정 만들기', dur: '0:26', yt: null,
    mp4: 'video/s1.mp4?v=2', poster: 'video/s1_poster.jpg?v=4', screen: '학교 설정', isNew: false,
  ...
  { id: 'S2', cat: 'start', art: 'cat_class', title: '수업 만들고 학생 넣기', dur: '0:26', yt: null,
    mp4: 'video/s2.mp4?v=3', poster: 'video/s2_poster.jpg?v=5', screen: '수업', isNew: false,
  ...
  { id: 'S3', cat: 'start', art: 'ruler_pen', guide: 'ch2.html', title: '채점기준 AI로 만들기', dur: '1:07', yt: null,
    mp4: 'video/s3.mp4?v=2', poster: 'video/s3_poster.jpg?v=4', screen: '수행평가 설계', isNew: false,
  ...
  { id: 'S4', cat: 'start', art: 'paths', guide: 'ch3.html', title: '과제물 받는 방법 정하고 올리기', dur: '1:01', yt: null,
    mp4: 'video/s4.mp4?v=3', poster: 'video/s4_poster.jpg?v=5', screen: '수행평가 설계 · 과제물 관리', isNew: false,
  ...
  { id: 'S5', cat: 'start', art: 'medal', guide: 'ch5.html', title: 'AI 채점 결과 확인하고 확정하기', dur: '1:03', yt: null,
    mp4: 'video/s5.mp4?v=2', poster: 'video/s5_poster.jpg?v=4', screen: '수행평가 채점', isNew: false,
  ...
  { id: 'D5', cat: 'start', art: 'export', title: '채점 결과 학생에게 공개하기', dur: '0:45', yt: null,
    mp4: 'video/d5.mp4?v=2', poster: 'video/d5_poster.jpg?v=4', screen: '수행평가 채점', isNew: false,
  ...
  { id: 'S6', cat: 'start', art: 'notebook', title: '채점 결과로 세특 초안 만들기', dur: '1:15', yt: null,
    mp4: 'video/s6.mp4?v=3', poster: 'video/s6_poster.jpg?v=5', screen: '수행평가 채점 · 세부능력 및 특기사항 지원', isNew: false,
  ...
  { id: 'B1', cat: 'design', art: 'target', title: '수행평가 새로 만들기', dur: '1:00', yt: null,
    mp4: 'video/b1.mp4?v=2', poster: 'video/b1_poster.jpg?v=4', screen: '수행평가 설계', isNew: false,
  ...
  { id: 'B6', cat: 'design', art: 'book_tags', title: '다른 선생님 평가계획 복사해서 쓰기', dur: '0:30', yt: null,
    mp4: 'video/b6.mp4?v=2', poster: 'video/b6_poster.jpg?v=4', screen: '평가계획 · 수행평가 설계', isNew: false,
  ...
  { id: 'P1', cat: 'design', art: 'clipboard', title: '평가계획에서 가져와 만들기', dur: '0:35', yt: null,
    mp4: 'video/p1.mp4?v=2', poster: 'video/p1_poster.jpg?v=4', screen: '평가계획 · 수행평가 설계', isNew: false,
  ...
  { id: 'B2', cat: 'design', art: 'tags', guide: 'ch2.html', title: '채점기준 AI로 만들기: 문장·활동지·사진', dur: '0:49', yt: null,
    mp4: 'video/b2.mp4?v=2', poster: 'video/b2_poster.jpg?v=4', screen: '수행평가 설계', isNew: false,
  ...
  { id: 'R1', cat: 'design', art: 'compass', guide: 'contest.html#tips', title: '채점기준 잘 쓰는 법', dur: '2:26', yt: null,
    mp4: 'video/rubric.mp4?v=7', poster: 'video/rubric_poster.jpg?v=8', screen: '수행평가 설계', isNew: false,
  ...
  { id: 'B5', cat: 'design', art: 'writing_log', since: '2026-09-22', title: '학생이 클리포에 직접 쓰는 과제 만들기', dur: '0:50', yt: null,
    mp4: 'video/b5.mp4?v=2', poster: 'video/b5_poster.jpg?v=4', screen: '수행평가 설계 · 과제물 관리', isNew: false,
  ...
  { id: 'C3', cat: 'files', art: 'scanner', guide: 'ch4.html', title: '반 전체 스캔 PDF 한 장으로 올리기', dur: '0:32', yt: null,
    mp4: 'video/c3.mp4?v=2', poster: 'video/c3_poster.jpg?v=4', screen: '과제물 관리', isNew: false,
  ...
  { id: 'C2', cat: 'files', art: 'upload_many', since: '2026-08-06', title: '여러 학생 파일 한 번에 올리기', dur: '0:33', yt: null,
    mp4: 'video/c2.mp4?v=2', poster: 'video/c2_poster.jpg?v=4', screen: '과제물 관리', isNew: false,
  ...
  { id: 'C1', cat: 'files', art: 'upload_one', title: '학생 한 명 과제물 따로 올리거나 바꾸기', dur: '0:51', yt: null,
    mp4: 'video/c1.mp4?v=2', poster: 'video/c1_poster.jpg?v=4', screen: '과제물 관리', isNew: false,
  ...
  { id: 'C4', cat: 'files', art: 'send', title: '학생 작성 과정 기록 보기', dur: '0:35', yt: null,
    mp4: 'video/c4.mp4?v=1', poster: 'video/c4_poster.jpg?v=3', screen: '과제물 관리', isNew: false,
  ...
  { id: 'C6', cat: 'files', art: 'phone_up', title: '학생 제출 화면 살펴보기', dur: '0:36', yt: null,
    mp4: 'video/c6.mp4?v=1', poster: 'video/c6_poster.jpg?v=3', screen: '학생 화면', isNew: false,
  ...
  { id: 'R2', cat: 'files', art: 'compass', guide: 'ch3.html', title: 'AI가 잘 읽는 과제물 준비하기', dur: '1:38', yt: null,
    mp4: 'video/prepare.mp4?v=1', poster: 'video/prepare_poster.jpg?v=3', screen: '과제물 관리', isNew: false,
  ...
  { id: 'D1', cat: 'grading', art: 'magnifier', guide: 'ch4.html', title: 'AI로 채점할 수 있는 답안', dur: '1:05', yt: null,
    mp4: 'video/d1.mp4?v=1', poster: 'video/d1_poster.jpg?v=3', screen: '수행평가 채점', isNew: false,
  ...
  { id: 'D2', cat: 'grading', art: 'bubble_score', guide: 'ch5.html', title: 'AI 채점하고 점수 확정하기', dur: '1:26', yt: null,
    mp4: 'video/d2.mp4?v=1', poster: 'video/d2_poster.jpg?v=3', screen: '수행평가 채점', isNew: false,
  ...
  { id: 'D3', cat: 'grading', art: 'bubble_pen', title: '피드백 다듬고 학생에게 공개하기', dur: '1:19', yt: null,
    mp4: 'video/d3.mp4?v=1', poster: 'video/d3_poster.jpg?v=3', screen: '수행평가 채점', isNew: false,
  ...
  { id: 'E0', cat: 'record', art: 'notebook', title: '채점 결과로 세특 초안 만들기', dur: '1:15', yt: null,
    mp4: 'video/e0.mp4?v=1', poster: 'video/e0_poster.jpg?v=3', screen: '수행평가 채점 · 세부능력 및 특기사항 지원', isNew: false,
  ...
  { id: 'E1', cat: 'record', art: 'compass', since: '2026-07-22', title: '세특 초안 다듬기', dur: '0:38', yt: null,
    mp4: 'video/e1.mp4?v=1', poster: 'video/e1_poster.jpg?v=3', screen: '세부능력 및 특기사항 지원 · 세특 간편 생성기', isNew: false,
  ...
  { id: 'E2', cat: 'record', art: 'book_tags', title: '채점 없이 세특 만들기 (간편 생성기)', dur: '0:56', yt: null,
    mp4: 'video/e2.mp4?v=1', poster: 'video/e2_poster.jpg?v=3', screen: '세특 간편 생성기', isNew: false,
  ...
  { id: 'E3', cat: 'record', art: 'clipboard', title: '활동지·설문 올려 창체 초안 만들기', dur: '1:10', yt: null,
    mp4: 'video/e3.mp4?v=1', poster: 'video/e3_poster.jpg?v=3', screen: '창의적 체험활동', isNew: false,
  ...
  { id: 'E4', cat: 'record', art: 'quote', title: '키워드와 일화로 행특 초안 만들기', dur: '1:15', yt: null,
    mp4: 'video/e4.mp4?v=2', poster: 'video/e4_poster.jpg?v=4', screen: '행동특성 및 종합기록 지원', isNew: false,
  ...
  { id: 'A1', cat: 'school', art: 'sheet', title: '학생 계정 만들기 (한 명씩·엑셀로)', dur: '0:32', yt: null,
    mp4: 'video/a1.mp4?v=1', poster: 'video/a1_poster.jpg?v=3', screen: '학교 설정 · 학생', isNew: false,
  ...
  { id: 'A2', cat: 'school', art: 'lock', title: '학생 비밀번호 바꾸고 정보 고치기', dur: '0:25', yt: null,
    mp4: 'video/a2.mp4?v=1', poster: 'video/a2_poster.jpg?v=3', screen: '학교 설정 · 학생', isNew: false,
  ...
  { id: 'A5', cat: 'school', art: 'stamp', title: '선생님 인증 승인하고 권한 바꾸기', dur: '0:30', yt: null,
    mp4: 'video/a5.mp4?v=1', poster: 'video/a5_poster.jpg?v=3', screen: '학교 설정 · 선생님', isNew: false,
  ...
  { id: 'A10', cat: 'school', art: 'coins', title: '학교 이용권·공유 크레딧 관리하기', dur: '0:31', yt: null,
    mp4: 'video/a10.mp4?v=1', poster: 'video/a10_poster.jpg?v=3', screen: '학교 설정 · 학교 이용권 관리', isNew: false,
  ...
  { id: 'F4', cat: 'school', art: 'swap_school', title: '학교 옮길 때 소속 바꾸기', dur: '0:36', yt: null,
    mp4: 'video/f4.mp4?v=1', poster: 'video/f4_poster.jpg?v=3', screen: '내 정보', isNew: false,
