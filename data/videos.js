...
window.VIDEOS = [
  ...
  { id: 'S1', cat: 'start', art: 'people_plus', title: '학교 설정에서 학생 계정 만들기', dur: '0:26', yt: null,
    mp4: 'video/s1.mp4?v=1', poster: 'video/s1_poster.jpg?v=1', screen: '학교 설정', isNew: false,
  ...
  { id: 'S2', cat: 'start', art: 'cat_class', title: '수업 만들고 학생 넣기', dur: '0:26', yt: null,
    mp4: 'video/s2.mp4?v=2', poster: 'video/s2_poster.jpg?v=2', screen: '수업', isNew: false,
  ...
  { id: 'S3', cat: 'start', art: 'ruler_pen', guide: 'ch2.html', title: '채점기준 AI로 만들기', dur: '1:07', yt: null,
    mp4: 'video/s3.mp4?v=1', poster: 'video/s3_poster.jpg?v=1', screen: '수행평가 설계', isNew: false,
  ...
  { id: 'S4', cat: 'start', art: 'paths', guide: 'ch3.html', title: '과제물 받는 방법 정하고 올리기', dur: '1:01', yt: null,
    mp4: 'video/s4.mp4?v=2', poster: 'video/s4_poster.jpg?v=2', screen: '수행평가 설계 · 과제물 관리', isNew: false,
  ...
  { id: 'S5', cat: 'start', art: 'medal', guide: 'ch5.html', title: 'AI 채점 결과 확인하고 확정하기', dur: '1:03', yt: null,
    mp4: 'video/s5.mp4?v=1', poster: 'video/s5_poster.jpg?v=1', screen: '수행평가 채점', isNew: false,
