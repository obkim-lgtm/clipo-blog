...
window.VIDEOS = [
  ...
  { id: 'S0', cat: 'start', art: 'intro', guide: 'index.html', title: '클리포는 어떤 서비스인가요?', dur: '2:39', yt: null,
    mp4: 'https://training.clipo.ai/video/clipo_promo.mp4', poster: 'video/s0_poster.jpg?v=2', screen: '전체', isNew: true,
  ...
  { id: 'S1', cat: 'start', art: 'people_plus', title: '학교 설정에서 학생 계정 만들기', dur: '0:26', yt: null,
    mp4: 'video/s1.mp4?v=1', poster: 'video/s1_poster.jpg?v=1', screen: '학교 설정', isNew: true,
  ...
  { id: 'S2', cat: 'start', art: 'cat_class', title: '수업 만들고 학생 넣기', dur: '0:26', yt: null,
    mp4: 'video/s2.mp4?v=2', poster: 'video/s2_poster.jpg?v=2', screen: '수업', isNew: true,
  ...
  { id: 'S4', cat: 'start', art: 'paths', guide: 'ch3.html', title: '과제물 받는 방법 정하고 올리기', dur: '1:01', yt: null,
    mp4: 'video/s4.mp4?v=2', poster: 'video/s4_poster.jpg?v=2', screen: '수행평가 설계 · 과제물 관리', isNew: true,
  ...
  { id: 'D5', cat: 'start', art: 'export', title: '채점 결과 내보내고 학생에게 공개하기', dur: '0:45', yt: null,
    mp4: 'video/d5.mp4?v=1', poster: 'video/d5_poster.jpg?v=1', screen: '수행평가 채점', isNew: false,
  ...
  { id: 'C3', cat: 'files', art: 'scanner', guide: 'ch4.html', title: '반 전체 스캔 PDF 한 장으로 올리기', dur: '0:32', yt: null,
    mp4: 'video/c3.mp4?v=1', poster: 'video/c3_poster.jpg?v=1', screen: '과제물 관리', isNew: false,
