...
window.VIDEOS = [
  ...
  { id: 'A8', cat: 'class', art: 'cat_class', title: '수업 만들고 수정·보관·삭제하기', dur: '0:50', yt: null,
    mp4: 'video/a8.mp4?v=4', poster: 'video/a8_poster.jpg?v=5', screen: '홈 · 내 수업', isNew: false,
    summary: '홈의 수업 만들기에서 학기·학년, 과목, 수업명을 정해요. 만든 수업은 카드 메뉴에서 고치고, 다 쓴 수업은 보관해요. 삭제한 수업은 복구할 수 없어요.' },
  { id: 'A9', cat: 'class', art: 'people_plus', title: '참여 학생 더하고 빼기', dur: '0:40', yt: null,
  ...
  { id: 'B6', cat: 'design', art: 'book_tags', title: '다른 선생님 평가계획 복사해서 쓰기', dur: '0:33', yt: null,
    mp4: 'video/b6.mp4?v=3', poster: 'video/b6_poster.jpg?v=4', screen: '평가계획 · 수행평가 설계', isNew: false,
    summary: '평가계획의 복사해서 만들기에서 다른 선생님이 만든 평가계획을 찾아 복사해요. 복사한 계획은 수행평가 설계에서 평가계획에서 가져오기로 불러와요.' },
  { id: 'P1', cat: 'design', art: 'clipboard', title: '평가계획에서 가져와 만들기', dur: '0:39', yt: null,
    mp4: 'video/p1.mp4?v=3', poster: 'video/p1_poster.jpg?v=4', screen: '평가계획 · 수행평가 설계', isNew: false,
  ...
  { id: 'B2', cat: 'design', art: 'tags', guide: 'ch2.html', title: '채점기준 AI로 만들기: 문장·활동지·사진', dur: '0:53', yt: null,
  ...
  { id: 'B5', cat: 'design', art: 'writing_log', since: '2026-09-22', title: '학생이 클리포에 직접 쓰는 과제 만들기', dur: '0:54', yt: null,
    mp4: 'video/b5.mp4?v=3', poster: 'video/b5_poster.jpg?v=4', screen: '수행평가 설계 · 과제물 관리', isNew: false,
  ...
  { id: 'C3', cat: 'files', art: 'scanner', guide: 'ch4.html', title: '반 전체 스캔 PDF 한 장으로 올리기', dur: '0:36', yt: null,
    mp4: 'video/c3.mp4?v=3', poster: 'video/c3_poster.jpg?v=4', screen: '과제물 관리', isNew: false,
    summary: '반 전체를 스캔한 PDF 한 개를 올리면 학생별로 나눠져요. 학생 한 명이 몇 장인지, 몇 쪽부터 과제인지 적고, 나뉜 결과가 다르면 고쳐서 등록해요.' },
  { id: 'C2', cat: 'files', art: 'upload_many', since: '2026-08-06', title: '여러 학생 파일 한 번에 올리기', dur: '0:36', yt: null,
    mp4: 'video/c2.mp4?v=3', poster: 'video/c2_poster.jpg?v=4', screen: '과제물 관리', isNew: false,
    summary: '학생별로 나뉜 과제물 파일을 한 번에 올리면, 파일 이름의 학생 이름으로 자동으로 짝지어져요. 짝이 틀리면 매칭 수정으로 바꿔요.' },
  { id: 'C1', cat: 'files', art: 'upload_one', title: '학생 한 명 과제물 따로 올리거나 바꾸기', dur: '0:54', yt: null,
    mp4: 'video/c1.mp4?v=3', poster: 'video/c1_poster.jpg?v=4', screen: '과제물 관리', isNew: false,
  ...
  { id: 'C4', cat: 'files', art: 'send', title: '학생 작성 과정 기록 보기', dur: '0:38', yt: null,
    mp4: 'video/c4.mp4?v=2', poster: 'video/c4_poster.jpg?v=3', screen: '과제물 관리', isNew: false,
  ...
  { id: 'D3', cat: 'grading', art: 'bubble_pen', title: '피드백 다듬고 학생에게 공개하기', dur: '1:23', yt: null,
    mp4: 'video/d3.mp4?v=2', poster: 'video/d3_poster.jpg?v=3', screen: '수행평가 채점', isNew: false,
  ...
  { id: 'E0', cat: 'record', art: 'notebook', title: '채점 결과로 세특 초안 만들기', dur: '1:18', yt: null,
    mp4: 'video/e0.mp4?v=2', poster: 'video/e0_poster.jpg?v=3', screen: '수행평가 채점 · 세부능력 및 특기사항 지원', isNew: false,
    summary: '세특은 마감한 수행평가로만 만들어요. 채점 목록에서 마감한 뒤 생성 옵션을 정하고, 학생마다 다른 초안을 받아 기록 근거를 보며 고쳐요.' },
  { id: 'E1', cat: 'record', art: 'compass', since: '2026-07-22', title: '세특 초안 다듬기', dur: '0:42', yt: null,
    mp4: 'video/e1.mp4?v=2', poster: 'video/e1_poster.jpg?v=3', screen: '세부능력 및 특기사항 지원 · 세특 간편 생성기', isNew: false,
    summary: 'AI 기록 다듬기에서 학생을 여러 명 고르고 "분량을 줄여 줘"처럼 방향을 적으면 다시 써 줘요. 화살표로 다듬기 전 기록과 비교해요.' },
  { id: 'E2', cat: 'record', art: 'book_tags', title: '채점 없이 세특 만들기 (간편 생성기)', dur: '1:00', yt: null,
    mp4: 'video/e2.mp4?v=2', poster: 'video/e2_poster.jpg?v=3', screen: '세특 간편 생성기', isNew: false,
    summary: '채점한 과제물이 없어도 과목·성취기준과 학생별 키워드·활동, 자기평가서 같은 자료로 세특 초안을 만들어요. 엑셀로 내려받아 나이스에 올려요.' },
  { id: 'E3', cat: 'record', art: 'clipboard', title: '활동지·설문 올려 창체 초안 만들기', dur: '1:14', yt: null,
  ...
  { id: 'A5', cat: 'school', art: 'stamp', title: '선생님 인증 승인하고 권한 바꾸기', dur: '0:34', yt: null,
    mp4: 'video/a5.mp4?v=2', poster: 'video/a5_poster.jpg?v=3', screen: '학교 설정 · 선생님', isNew: false,
    summary: '대표교사가 인증 대기에서 새 선생님을 승인하거나 거절하고, 권한 변경에서 대표교사·일반교사를 바꿔요. 대표교사는 한 명 이상 필요해요.' },
  { id: 'A10', cat: 'school', art: 'coins', title: '학교 이용권·공유 크레딧 관리하기', dur: '0:35', yt: null,
  ...
  // 계정·이용권
  // 계정·이용권 — 3편(09-26 올립: 견적서·영수증 F5는 F3에 합침, 소속 변경 F4는 학교 설정 탭)
  { id: 'F1', cat: 'account', art: 'coins', title: 'AI 크레딧 알아보기', dur: '0:40', yt: null,
    mp4: 'video/f1.mp4?v=2', poster: 'video/f1_poster.jpg?v=1', screen: '이용권 관리', isNew: false,
    summary: 'AI를 실행할 때 학생 한 명에 크레딧 1개가 쓰여요. 데일리 크레딧은 매일 자정에 채워지고, 추가 크레딧은 유효 기간까지 남아요. 내역 상세에서 만료일과 쓰는 순서를 봐요.' },
  { id: 'F2', cat: 'account', art: 'ticket', title: '이용권 사고 쿠폰 등록하기', dur: '0:44', yt: null,
    mp4: 'video/f2.mp4?v=2', poster: 'video/f2_poster.jpg?v=1', screen: '요금제 알아보기 · 이용권 관리', isNew: false,
    summary: '요금제 알아보기의 개인 탭에서 이용권을 사고, 쿠폰은 이용권 관리에서 등록해요. 크레딧이 모자라면 추가 충전을 살 수 있어요. 취소는 결제일로부터 7일 안에 요청해요.' },
  { id: 'F3', cat: 'account', art: 'building', title: '학교 단체로 도입하기', dur: '0:40', yt: null,
    mp4: 'video/f3.mp4?v=2', poster: 'video/f3_poster.jpg?v=1', screen: '요금제 알아보기 · 학교 도입', isNew: false,
    summary: '5명 이상이면 수량별로 최대 30% 할인과 학교 공유 크레딧을 받아요. 예상 견적을 계산해 보고 학교장터나 도입 문의로 신청해요. 견적서 같은 서류도 도입 문의로 요청해요.' },
];
